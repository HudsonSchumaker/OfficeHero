...
public class HsScore3_1 : MonoBehaviour {
	...
	private void Start () {
		...
		score.text = "Score: " + PlayerPrefs.GetInt("ScoreLv3-1");
		strike.text = "Longest Strike: "+ PlayerPrefs.GetInt("StrikeLv3-1");
	}

	private void Update () {
		delay -= Time.deltaTime;
		if(delay <= 0.0f){
			SceneManager.LoadScene("_PreWeek3_2");
		}
	}
}
