...
public class HsScore3_2 : MonoBehaviour {
	...
	private void Start () {
		...
		score.text = "Score: " + PlayerPrefs.GetInt("ScoreLv3-2");
		strike.text = "Longest Strike: "+ PlayerPrefs.GetInt("StrikeLv3-2");
	}

	private void Update () {
		delay -= Time.deltaTime;
		if(delay <= 0.0f){
			SceneManager.LoadScene("_PreWeek3_3");
		}
	}
}
