...
public class HsScore3_3 : MonoBehaviour {
	...
	private void Start () {
		...
		score.text = "Score: " + PlayerPrefs.GetInt("ScoreLv3-3");
		strike.text = "Longest Strike: "+ PlayerPrefs.GetInt("StrikeLv3-3");
	}

	private void Update () {
		delay -= Time.deltaTime;
		if(delay <= 0.0f){
			SceneManager.LoadScene("_PreWeek3_4");
		}
	}
}
