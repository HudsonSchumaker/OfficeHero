...
public class HsScore3_4 : MonoBehaviour {
	...
	private void Start () {
		...
		score.text = "Score: " + PlayerPrefs.GetInt("ScoreLv3-4");
		strike.text = "Longest Strike: "+ PlayerPrefs.GetInt("StrikeLv3-4");
	}

	private void Update () {
		delay -= Time.deltaTime;
		if(delay <= 0.0f){
			SceneManager.LoadScene("_PreWeek3_5");
		}
	}
}
