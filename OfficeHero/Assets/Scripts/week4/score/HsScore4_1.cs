...
public class HsScore4_1 : MonoBehaviour {
	...
	private void Start () {
		...
		score.text = "Score: " + PlayerPrefs.GetInt("ScoreLv4-1");
		strike.text = "Longest Strike: "+ PlayerPrefs.GetInt("StrikeLv4-1");
	}

	private void Update () {
		delay -= Time.deltaTime;
		if(delay <= 0.0f){
			SceneManager.LoadScene("_PreWeek4_2");
		}
	}
}
