...
public class HsScore4_2 : MonoBehaviour {
	...
	private void Start () {
		...
		score.text = "Score: " + PlayerPrefs.GetInt("ScoreLv4-2");
		strike.text = "Longest Strike: "+ PlayerPrefs.GetInt("StrikeLv4-2");
	}

	private void Update () {
		delay -= Time.deltaTime;
		if(delay <= 0.0f){
			SceneManager.LoadScene("_PreWeek4_3");
		}
	}
}
